...
export default function Call() {
  return (
    <ScrollView style={{flex:1,backgroundColor:"white"}}>
      <View style={{height: "auto",flexDirection:"row",justifyContent:"center",gap:33,alignItems:"center",paddingBlock:20}}>
...
<Text style={{fontSize:12,marginTop:5}}>Favourite</Text>
      ...
      <View style={{paddingInline:20,flexDirection:"row",marginBottom:20}}>
        <View>
       ...
       <View style={{paddingStart:7,justifyContent:"center"}}>
                ...
                <Text style={{gap:9,paddingBlock:4,fontSize:10,paddingStart:2,justifyContent:"center",alignItems:"center",}}>
                  <MaterialIcons name="call-made" size={10} color="#14d21e" /> Today, 7:47 AM
                </Text>
              </View>
              <View style={{flex:1,justifyContent:"center",alignItems:"flex-end"}}><AntDesign name="video-camera" size={24} color="black" /></View>
      </View>
      <View style={{paddingInline:20,flexDirection:"row",marginBottom:20}}>
        <View>
          <Image  source={require("../../assets/images/abhisheksir.jpeg")} style={{ width: 45, height: 45, borderRadius: 100,borderWidth:2, }}/>
